...
target_folder = "ctrnn-pole/rnn-exp-002"
filesaver = fs.FileSaver(f"{target_folder}/sim-movies", "sim", 3)
with open(f'{target_folder}/winner-ctrnn', 'rb') as f:
    c = pickle.load(f)
...
print()
print("Making movie...")
make_movie(net, discrete_actuator_force, 15.0, f"{filesaver.getNextPath('.mp4')}")