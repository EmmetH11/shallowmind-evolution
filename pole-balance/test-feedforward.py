...
# load the winner
target_folder = "ff-pole/ff-exp-005"
with open(f'{target_folder}/winner-feedforward', 'rb') as f:
    c = pickle.load(f)
...
# print("Making movie...")
make_movie(net, discrete_actuator_force, 120.0, f"{target_folder}/feedforward-movie.mp4")